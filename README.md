...
```
git clone git@github.com:nehasadhvi/Appointment-Management.git
```
or
```
git clone https://github.com/nehasadhvi/Appointment-Management.git
```
...
* [IndexedDB] - Used to save the structured data locally 
